...
const registrarSalidaAlumnos = (params) => {
    ...
    return new Promise((resolve, reject) => {
        ...
        console.log(" Params  " + JSON.stringify(params));
        const { listaSalida = [], listaCalcularHorasExtras = [],id_empresa, genero } = params;
        ...
        procesoSalidaAlumnos(listaSalida, listaCalcularHorasExtras,id_empresa, genero)
            .then(results => {
...
const procesoSalidaAlumnos = (idSalidas, arrayIdSalidasCalcularHoraExtras = [], idEmpresa, genero) => {
    ...
    console.log(`SELECT registrar_salida_alumno('${idsAsistencias}','${idsAsistenciasCalculoHorasExtras}',${idEmpresa},${genero});`);
    return genericDao.executeProcedure(`SELECT registrar_salida_alumno('${idsAsistencias}','${idsAsistenciasCalculoHorasExtras}',${idEmpresa},${genero});`);
};
...
/*
si se desea activar enviar la empresa al procesoSalidaAlumno
