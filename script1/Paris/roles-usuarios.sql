...
insert into si_usuario_sucursal_rol(usuario,si_rol,co_sucursal,co_empresa,genero)
values(125,(select id from si_rol where nombre='DIRECTOR'),1,1,1);
...
update si_opcion set si_opcion = 7 where id = 9;
  ...
  update si_opcion set orden = 1 where id = 6;
        update si_opcion set orden = 2 where id = 7;
        update si_opcion set orden = 3 where id = 8;
        update si_opcion set orden = 4 where id = 11;
        update si_opcion set orden = 5 where id = 10;
